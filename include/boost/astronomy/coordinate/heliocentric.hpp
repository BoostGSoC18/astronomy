    ...
    namespace astronomy
    {
        namespace coordinate
        {
            ...
            public:
                ...
                heliocentric(Represetation const& representation_data) : base_ecliptic_frame(representation_data) {}

                heliocentric(double lat, double lon, double distance) : base_ecliptic_frame(lat, lon, distance) {}
