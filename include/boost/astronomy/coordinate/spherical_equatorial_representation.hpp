    ...
    namespace astronomy
    {
        namespace coordinate
        {
            ...
            public:
                ...
                spherical_equatorial_representation(boost::geometry::model::point<double, DimensionCount, System> const& pointObject)
                {
                ...
                //!when spherical_equatorial_representation and spherical_coslat_differential are  added dist component of differential is ignored
                boost::astronomy::coordinate::spherical_equatorial_representation<DegreeOrRadian>
                    operator +(boost::astronomy::coordinate::spherical_coslat_differential<DegreeOrRadian> const& diff) const
                {
                    boost::astronomy::coordinate::spherical_equatorial_representation<DegreeOrRadian> temp(this->diff);
